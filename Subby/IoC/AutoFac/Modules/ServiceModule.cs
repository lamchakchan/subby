...
namespace Subby.IoC.AutoFac.Modules
{
    public class ServiceModule : Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<DefaultResourceProcessService>().As<ICompositeResourceProcessService>().SingleInstance();
            ...
            builder.RegisterType<NewLineParser>().As<INewLineVariableParser>().SingleInstance();
        }
    }
}