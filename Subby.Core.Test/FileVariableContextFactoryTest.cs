...
namespace Subby.Core.Test
{
    ...
    {
        IFileVariableContextFactory factory = new FileVariableContextFactory(new DefaultContentTypeService());
    ...
    {
        IVariablesContextFactory<SourceContext> factory = new DefaultVariableContextFactory(new FileVariableContextFactory(new DefaultContentTypeService()), new HttpVariableContextFactory(new DefaultContentTypeService()));
